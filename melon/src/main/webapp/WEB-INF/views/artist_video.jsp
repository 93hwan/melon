...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${pageContext.request.contextPath}/artist/artist_video/${arti_main_static.artist_no }">뮤직비디오</a></li>
		...
		<c:forEach items="${arti_muVideo}" varStatus="status" var="i">
			<tr>
				<td>
					...
					<br>
					<strong><a href="${pageContext.request.contextPath}/album/music_info/${i.music_no }">${i.title }</a></strong> <img align="middle" alt="좋아요" src="https://raw.githubusercontent.com/google/material-design-icons/master/av/2x_web/ic_play_circle_outline_black_48dp.png" width="18px" height="18px" onclick=""><br>
					<a href="${pageContext.request.contextPath}/artist/main/${i.artist_no}">${i.artist_name }</a><br>
