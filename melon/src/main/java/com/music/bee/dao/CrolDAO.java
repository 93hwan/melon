...
public interface CrolDAO {
	...
	//팝송
	public void pop_album(String album_num,String album_title,String artist_name,String album_img,String relDate);
	public void pop(String music_num,String album_title,String title,String artistName,String genre, String video, String lyrics, String relDate);
}
